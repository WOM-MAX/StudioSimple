    ...
    sections: [
      {
        ...
        children: [
            ...
            children: [
              ...
              new TextRun({
                text: oa.referenciaTextoEscolar
                  ...
                  : "Material Oficial MINEDUC 7° Básico (MATERIALES/110-7)"
              })
            ]
          }),
          new Paragraph({
          ...
          ...lessons.flatMap((lesson) => [
            ...
            ...lesson.paso5_practica.flatMap((p, idx) => [
              ...
              new Paragraph({
                ...
                children: [
                  ...
                  new TextRun({ text: " | Pista: ", bold: true }),
            ...
            // PASO 6 & 7 & 8
            new Paragraph({
              text: "Pasos 6, 7 y 8: Resumen, Miniquiz y Cierre",
              heading: HeadingLevel.HEADING_2,
            ...
            new Paragraph({
              spacing: { after: 100 },
              children: [
                new TextRun({ text: "Idea Clave (Paso 6): ", bold: true }),
                new TextRun({ text: lesson.paso6_resumen.ideaClave })
              ]
            }),
            new Paragraph({
              spacing: { after: 50 },
              children: [new TextRun({ text: "Miniquiz de Evaluación (Paso 7):", bold: true })]
            }),
            ...lesson.paso7_miniquiz.flatMap((q, idx) => [
              ...
              new Paragraph({
                spacing: { after: 60 },
                children: [
                  new TextRun({ text: `Alternativas: ${q.options.join(" | ")}\n` }),
                  new TextRun({ text: `Correcta: ${q.correct} | Justificación: ${q.fixExplain}`, italics: true, color: "047857" })
                ]
              })
            ]),
            new Paragraph({
              ...
              children: [
                new TextRun({ text: "Cierre y Celebración (Paso 8): ", bold: true }),
